                                            ...
                                            child: PopupMenuButton(
                                                ...
                                                itemBuilder: (context) => [
                                                  ...listFilter.map((e) => PopupMenuItem(
                                                      ...
                                                      child: BlocProvider(create: (c)=>CheckBoxFilterCubit(e == AppText.optInProgress.text ? cubit.listFilter[0] : cubit.listFilter[1]),child: BlocBuilder<CheckBoxFilterCubit,bool>(builder: (cc,state){
                                                        return CheckboxListTile(
                                                          controlAffinity: ListTileControlAffinity.leading,
                                                          title: Text(e),
                                                          value: state,
                                                          onChanged: (newValue) {
                                                            cubit.listFilter[listFilter.indexOf(e)] = newValue!;
