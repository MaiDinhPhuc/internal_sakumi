...
class ReportScreen extends StatelessWidget {
  ReportScreen({super.key, required this.role})
      : cubit = ReportCubit();
  final String role;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          HeaderTeacher(
              index: 5, classId:TextUtils.getName(), role: role),
          Expanded(child: BlocBuilder<ReportCubit, int>(
                  ...
                  child: CircularProgressIndicator(),
                    ...
                    child: Column(
                      children: [
                        ...
                        vertical: Resizable.padding(context, 20)),child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                showDialog(
                                    context: context,
                                    builder: (context) => AddNewReportDialog(reportCubit: cubit, isEdit: false));
                              },
                              child: Container(
