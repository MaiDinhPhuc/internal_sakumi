enum AppText {
  ...
  txtDuplicateLinkBetweenClasses,
  titleManageVoucher,
  titleVoucherCode,
  titleInfoVoucher,
  titleApplyCourse,
...
Map<AppText, String> texts = {
  ...
  AppText.txtAddNewSubCourse: "+ Thêm khoá tự học",
  AppText.titleNoSubCourse:
      "Sensei hãy liên lạc với Team Support để có thể được hỗ trợ thêm về các khóa học nhằm phục vụ cho việc dạy học tốt hơn nhé.",
  AppText.txtNoSubCourse: "Không có khóa tự học",
  AppText.txtSubCourse: "Tự học",
  AppText.txtNotFill: "Chưa nhập",
  AppText.txtRating: "Xếp hạng",
  AppText.txtScheduleTeacher: "Sắp xếp lịch dạy",
  ...
  AppText.txtNotLog:
      "Hiện tại không có ghi chép thay đổi của học viên phù hợp...",
  ...
  AppText.txtAnonymousNote:
      "Chọn \"Ẩn Danh\" để góp ý không gửi kèm thông tin cá nhân",
  AppText.txtAnonymous: "Ẩn danh",
  AppText.txtPleaseInputFeedBack:
      "Vui lòng gửi góp ý cho trung tâm nếu có gì sensei thấy sai sót nhé...",
  ...
  AppText.txtConfirmDeleteBill:
      "Xác nhận xóa hóa đơn. Vui lòng kiểm tra kĩ trước khi xóa!",
  AppText.txtConfirmCheckBill:
      "Xác nhận đối xoát hóa đơn. Vui lòng kiểm tra kĩ trước khi đối xoát!",
  ...
  AppText.txtNotBill:
      "Hiện tại không có hoá đơn thoả mãn điều kiện, vui lòng chọn lại filter...",
  ...
  AppText.txtConfirmRecallSurvey:
      'SS chắc chắn muốn thu hồi bài khảo sát này???',
  ...
  AppText.txtConfirmActiveSurvey:
      'Xác nhận muốn kích hoạt bài khảo sát hay không? \nLưu ý: Kích hoạt thành công sẽ không thể chỉnh sửa bài khảo sát!',
  ...
  AppText.txtErrorNotFoundLinkGGMeetOnDB:
      'Không tìm thấy link Google Meet trên Database',
  AppText.txtDuplicateLinkBetweenClasses:
  ...
  AppText.txtInstructionTool: 'Nhấn nút xác minh để lấy file trên Google Drive',
  ...
  AppText.txtStillSomeErrorVideo:
      'Vẫn còn một số link video bị lỗi, vui lòng kiểm tra lại',
