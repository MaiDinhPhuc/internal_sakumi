...
extension FilterClassCourseEx on FilterClassCourse {
  String get title {
    switch(this) {
      case FilterClassCourse.kaiwa : return  "Kaiwa";
      case FilterClassCourse.jlpt : return  "JLPT";
      case FilterClassCourse.general : return  "General";
      case FilterClassCourse.kid : return  "Kid";
    }
  }
}
...
extension FilterClassLevelEx on FilterClassLevel {
  String get title {
    switch(this) {
      case FilterClassLevel.n1 : return  "N1";
      case FilterClassLevel.n2 : return  "N2";
      case FilterClassLevel.n3 : return  "N3";
      case FilterClassLevel.n4 : return  "N4";
      case FilterClassLevel.n5 : return  "N5";
      case FilterClassLevel.other : return  "Other";
    }
  }
}
...
extension FilterClassStatusEx on FilterClassStatus {
  ...
  String get title{
    switch(this) {
      case FilterClassStatus.preparing : return  "Mới tạo";
      case FilterClassStatus.completed : return  "Hoàn thành";
      case FilterClassStatus.studying : return  "Đang học";
      case FilterClassStatus.cancel : return  "Huỷ";
    }
  }
}
...
class AdminClassFilterCubit extends Cubit<int> {
  ...
  static const Map<AdminFilter, List> defaultFilter = {
    ...
    AdminFilter.course: [],
    AdminFilter.level: [],
    AdminFilter.status: [FilterClassStatus.preparing,FilterClassStatus.studying],
  };
