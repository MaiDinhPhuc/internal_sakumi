                            ...
                            Container(
                              ...
                              child: SubmitButton(
                                  onPressed: () {
                                    ...
                                    if(cubit.testInfo["course_id"] == null){
                                      notificationDialog(context, AppText.txtPleaseChooseCourse.text);
                                    }else if(cubit.testInfo["test_id"] == null){
                                      notificationDialog(context,AppText.txtPleaseChooseTest.text );
                                    }else{
