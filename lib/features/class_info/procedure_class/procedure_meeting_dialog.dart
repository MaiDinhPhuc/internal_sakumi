...
class ProcedureMeetingDialog extends StatelessWidget {
  ProcedureMeetingDialog({super.key, required this.procedureClassModel, required this.type, required this.procedureClassCubit, required this.itemCubit}) : cubit = ProcedureMeetingDialogCubit(procedureClassCubit, itemCubit);
                    ...
                    Expanded(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                                flex: 2,
                                child: MeetingItemListV2(cubit: cubit, type: type, isCustom: itemCubit.procedure!.isCustom,)),
                            Expanded(
                                flex: 5,
