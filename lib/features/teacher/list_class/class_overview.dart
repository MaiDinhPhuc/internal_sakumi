...
class ClassOverview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ClassItemRowLayout(
        widgetClassCode: AutoSizeText(
            cubit.listClassCodes![index].toUpperCase(),
            style: TextStyle(
        ...
        widgetSubmit: cubit.rateSubmit == null || cubit.rateAttendance!.isEmpty
            ? Center(
                child: Transform.scale(
                  scale: 0.75,
                  child: const CircularProgressIndicator(),
  ...
  Widget build(BuildContext context) {
    ...
    return ClassItemRowLayout(
      ...
      widgetSubmit: cubit.rateSubmit == null || cubit.rateAttendance!.isEmpty
          ...
          : CircleProgress(
              title: '${(cubit.rateSubmit![index] * 100).toStringAsFixed(0)} %',
              lineWidth: Resizable.size(context, 3),
              percent: cubit.rateSubmit![index],
              radius: Resizable.size(context, 15),
              fontSize: Resizable.font(context, 14),
