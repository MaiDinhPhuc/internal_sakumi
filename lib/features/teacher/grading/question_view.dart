...
class QuestionView extends StatelessWidget {
  const QuestionView({super.key, required this.questionModel, required this.soundCubit, required this.cubit});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (questionModel.sound != "")
          Row(
            children: [
              Expanded(
                child: Padding(
                  padding: EdgeInsets.only(right: Resizable.padding(context, 350)),
                  child: Sounder(
        ...
        if (questionModel.questionType == 1 || questionModel.questionType == 5)
