...
class AnswerInfoView extends StatelessWidget {
  const AnswerInfoView({super.key, required this.answerModel, required this.soundCubit, required this.cubit});
  ...
  Widget build(BuildContext context) {
    final TextEditingController noteController = TextEditingController(text: answerModel.newTeacherNote);
    return Column(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              ...
              color: Colors.white),
          child: Text(
            cubit.getStudentNam(answerModel),
            style: TextStyle(fontWeight: FontWeight.w800, fontSize: Resizable.font(context, 18)),
          ),
        ),
        Container(
          padding: EdgeInsets.symmetric(
          ...
          child: Column(
            children: [
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  answerModel.answer.isEmpty? Expanded(
                      flex: 7,
                      child: Text(
                      ...
                      child: (answerModel.questionType == 1 ||
                        ...
                        answer: answerModel,
                          ...
                          : SoundView(answer: answerModel,soundCubit: soundCubit)),
                  Expanded(
                      ...
                      child: BlocProvider(
                        ...
                        cubit.listAnswer![cubit.listAnswer!.indexOf(answerModel)].score.toString()
