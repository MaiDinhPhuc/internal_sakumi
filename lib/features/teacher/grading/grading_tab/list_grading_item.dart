    ...
    return Column(
      children: [
        if ((cubit.isBTVN && cubit.filterListLesson().isNotEmpty) ||
            (!cubit.isBTVN && cubit.filterListTest().isNotEmpty))
          GradingItemLayout(
              title: Padding(
                  padding:
              ...
              receivedNUmber: Text(AppText.textNumberResultReceive.text,
                  style: TextStyle(
                      fontWeight: FontWeight.w600,
                      color: const Color(0xff757575),
                      fontSize: Resizable.font(context, 17))),
              gradingNumber: Text(AppText.txtGradingNumber.text,
                  style: TextStyle(
                      fontWeight: FontWeight.w600,
                      color: const Color(0xff757575),
                      fontSize: Resizable.font(context, 17))),
        ...
        if ((cubit.isBTVN && cubit.filterListLesson().isEmpty) ||
          ...
          Padding(
            ...
            child: Text(AppText.txtNotGradingItem.text),
          )
      ],
    );
  }
