      ...
      children: [
        Expanded(child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                color: const Color(0xffE0E0E0), width: Resizable.size(context, 0.5),
              )
          ),
          child: Column(
            children: [
              Align(
                ...
                child: Text(AppText.txtQuantity.text, style: TextStyle(
        ...
        Expanded(child: Container(
          ...
          child: Column(
            children: [
              Align(
                alignment: Alignment.topLeft,
                child: Text(AppText.titleHomework.text, style: TextStyle(
                    color: const Color(0xff757575),
                    fontWeight: FontWeight.w600,
                    fontSize: Resizable.font(context, 20)
                )),
        ...
        Expanded(child: Container(
          ...
          child: Column(
            children: [
              Align(
                alignment: Alignment.topLeft,
                child: Text(AppText.txtPointOfTest.text, style: TextStyle(
                    color: const Color(0xff757575),
                    fontWeight: FontWeight.w600,
                    fontSize: Resizable.font(context, 20)
                )),
        ...
        Expanded(child: Container(
          ...
          child: Column(
            children: [
              Align(
                alignment: Alignment.topLeft,
                child: Text(AppText.txtEvaluate.text, style: TextStyle(
                    color: const Color(0xff757575),
                    fontWeight: FontWeight.w600,
                    fontSize: Resizable.font(context, 20)
                )),
              ),
              Expanded(child: Center(child: Text('A', //TODO ADD EVALUATE
                  style: TextStyle(
