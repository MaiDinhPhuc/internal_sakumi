  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
            flex: 1,
            child: index > cubit.listLessonResult!.length - 1
                ? Container()
            ...
            child: index > cubit.listLessonResult!.length - 1
                ? Opacity(
                    ...
                    child: CircleProgress(
                      title: index > cubit.listLessonResult!.length - 1
                          ? '0'
                          : '0 %',
                      lineWidth: Resizable.size(context, 3),
                      percent: 0,
                ...
                : cubit.listSubmitHomework == null ||
                    ...
                    : CircleProgress(
                        title: index > cubit.listLessonResult!.length - 1
                            ? '0'
                            : '${(((cubit.listSubmitHomework![index]) / (cubit.listStudentClass!.length)) * 100).toStringAsFixed(0)} %',
                        lineWidth: Resizable.size(context, 3),
                        percent: (cubit.listSubmitHomework![index]) /
                            (cubit.listStudentClass!.length),
                        radius: Resizable.size(context, 16),
                        fontSize: Resizable.font(context, 14),
                      )),
