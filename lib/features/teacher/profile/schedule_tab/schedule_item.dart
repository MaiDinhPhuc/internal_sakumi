...
class ScheduleItem extends StatelessWidget {
  const ScheduleItem({super.key, required this.cubit, required this.scheduleModel});
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
            color: scheduleModel.type == "single"? const Color(0xffFDE3E3) : const Color(0xffE3F2FD),
            border: Border.all(
        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color:scheduleModel.type == "single"? const Color(0xffFBBBBB) :  const Color(0xff90CAF9),
                  border: Border.all(
                      width: Resizable.size(context, 1),
                      color:scheduleModel.type == "single"? const Color(0xffFBBBBB) : const Color(0xff90CAF9)),
                  borderRadius:
              ...
              child: Text(
                scheduleModel.type == "single"? "Nghỉ" :"${scheduleModel.startTime} - ${scheduleModel.endTime}",
                style: TextStyle(color:scheduleModel.type == "single"? const Color(0xffA10D0D) : const Color(0xff0D47A1),
