...
class FilterReportRange extends StatelessWidget {
  const FilterReportRange({super.key, required this.cubit});
        ...
        child: ClipRRect(
          ...
          child: Material(
            ...
            child: PopupMenuButton(
                ...
                itemBuilder: (context) => [
                  ...cubit.listRange.map((e) => PopupMenuItem(
                      padding: EdgeInsets.zero,
                      child: BlocProvider(
                          create: (c) => CheckBoxFilterCubit(
                              cubit.range[cubit.listRange.indexOf(e)]),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                          child: Center(
                              child: Text(AppText.txtRange.text,
                                  style: TextStyle(
