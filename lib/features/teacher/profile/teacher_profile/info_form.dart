...
class InfoForm extends StatefulWidget {
  const InfoForm({Key? key, required this.profileCubit}) : super(key: key);
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          InputCustom(
            controller: listInfo[0]['controller'] as TextEditingController,
          ...
          InputCustom(
            controller: listInfo[1]['controller'] as TextEditingController,
          ...
          InputCustom(
            controller: listInfo[2]['controller'] as TextEditingController,
          ...
          InputCustom(
            controller: listInfo[3]['controller'] as TextEditingController,
