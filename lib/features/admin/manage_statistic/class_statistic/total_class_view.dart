...
class TotalClassView extends StatelessWidget {
  const TotalClassView({super.key, required this.filterController});
        ...
        Expanded(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(AppText.txtTotalClass.text,
                      style: TextStyle(
        ...
        Expanded(
            ...
            child: Container  (
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Text(AppText.txtTotalClassThisMonth.text,
                      style: TextStyle(
