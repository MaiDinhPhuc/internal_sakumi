...
class FilterBillCreatorDetail extends StatelessWidget {
  const FilterBillCreatorDetail({super.key, required this.detailCubit, });
        ...
        child: ClipRRect(
          ...
          child: Material(
            ...
            child: PopupMenuButton(
                ...
                itemBuilder: (context) => [
                  ...detailCubit.listCreator.map((e) => PopupMenuItem(
                      padding: EdgeInsets.zero,
                      child: BlocProvider(create: (c)=>CheckBoxFilterCubit(detailCubit.creators[detailCubit.listCreator.indexOf(e)]),child: BlocBuilder<CheckBoxFilterCubit,bool>(builder: (cc,state){
                        return CheckboxListTile(
                          controlAffinity: ListTileControlAffinity.leading,
                          title: Text(e),
                          value: state,
                          onChanged: (newValue) {
                            detailCubit.creators[detailCubit.listCreator.indexOf(e)] = newValue!;
                            if(detailCubit.creators.every((element) => element == false)){
                              detailCubit.creators[detailCubit.listCreator.indexOf(e)] = !newValue;
                            }else{
                              BlocProvider.of<CheckBoxFilterCubit>(cc).update();
                            }
