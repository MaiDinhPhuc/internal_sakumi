...
class FilterBillStatusView extends StatelessWidget {
  FilterBillStatusView({super.key, required this.filterController, required this.cubit}): selectCubit = SelectFilterCubit();
              ...
              child: ClipRRect(
                ...
                child: Material(
                  ...
                  child: PopupMenuButton(
                      onCanceled: (){
                        filterController.update(BillFilter.status, selectCubit.convertBillStatus());
                      },
                      itemBuilder: (context) => [
                        ...selectCubit.listBillStatus.map((e) => PopupMenuItem(
                            padding: EdgeInsets.zero,
                            child: BlocProvider(create: (c)=>CheckBoxFilterCubit(selectCubit.listSelect[selectCubit.listBillStatus.indexOf(e)]),child: BlocBuilder<CheckBoxFilterCubit,bool>(builder: (cc,state){
                              return CheckboxListTile(
                                controlAffinity: ListTileControlAffinity.leading,
                                title: Text(e.title),
                                value: state,
                                onChanged: (newValue) {
                                  selectCubit.listSelect[selectCubit.listBillStatus.indexOf(e)] = newValue!;
