...
class ConfirmChangeStudentStatus extends StatelessWidget {
  const ConfirmChangeStudentStatus( this.newStatus, this.studentClassModel,this.student,this.cubit,this.popupCubit,{Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(AppText.txtConfirmChangeStatus.text.replaceAll("@", student.name).replaceAll("#", vietnameseSubText(newStatus)).replaceAll("%", vietnameseSubText(studentClassModel.status)), style: const TextStyle(
      ...
      actions: [
        ...
        CustomButton(onPress: () async{
          FirebaseFirestore.instance
              ...
              .doc('student_${student.userId}_class_${studentClassModel.classId}')
              .update({
...
class ConfirmChangeStudentStatusOverView extends StatelessWidget {
  const ConfirmChangeStudentStatusOverView( this.newStatus, this.studentClassModel,this.student,this.cubit,this.popupCubit,{Key? key}) : super(key: key);
  final String newStatus;
  final StudentClassModel studentClassModel;
  final StudentModel student;
