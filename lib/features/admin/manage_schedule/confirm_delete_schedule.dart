...
class ConfirmDeleteSchedule extends StatelessWidget {
  const ConfirmDeleteSchedule({super.key, required this.onPress});
  final Function() onPress;
  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(AppText.txtConfirmDeleteSchedule.text, style: const TextStyle(
