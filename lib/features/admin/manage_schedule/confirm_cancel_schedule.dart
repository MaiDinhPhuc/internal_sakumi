...
class ConfirmCancelSchedule extends StatelessWidget {
  const ConfirmCancelSchedule({super.key, required this.onPress});
  final Function() onPress;
  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(AppText.txtConfirmCancelSchedule.text, style: const TextStyle(
