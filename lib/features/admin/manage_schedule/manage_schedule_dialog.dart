                          ...
                          children: [
                              ...
                              itemBuilder: (context, suggestion) {
                                ...
                                if (data["class_code"]
                                  ...
                                  return ItemSearchV2(
                                    ...
                                    id: data["class_id"],
                                    onTap: () async {
                                      manageCubit.classController.text =
                                          "${data["class_code"] ?? ""}";
                            ...
                            Expanded(
                              ...
                              children: [
                                Expanded(
                                    flex: 2,
                                    child:manageCubit.loadingTeacher?const Center(child: CircularProgressIndicator(),) : SingleChildScrollView(
                                      child: Column(
                                        children: [
                                          SizedBox(
                                              height:
                                                  Resizable.size(context, 10)),
                                          ...manageCubit.listSchedule!
                                              .map((e) => ItemSchedule(
                                                    type: e.type,
                                                    sensei: manageCubit.getTeacher(
                                                        e.teacherId),
                                                    info: manageCubit.getInfo(
                                                        e),
                                                    onTap: () {
                                                      manageCubit
                                                          .selectSchedule(e);
                                                    },
                                                    isChoose: manageCubit
                                                                .selectedSchedule ==
                                                            null
                                                        ? false
                                                        : manageCubit
                                        ...
                                        Column(
                                          children: [
                                            ...
                                            ScheduleDialogButton(
                                              ...
                                              onTap: () {
                                                if (manageCubit
                                                  ...
                                                  if(manageCubit
                                                      .selectedSchedule!.type == "cyclic"){
                                                    showDialog(
                                                        context: context,
                                                        builder: (context) =>
                                                            CyclicScheduleDialog(
                                                                cubit: cubit,
                                                                schedule: manageCubit
                                                                    .selectedSchedule));
                                                  }else{
                                                    showDialog(
                                                        context: context,
                                              ...
                                              icon: manageCubit
                                                          .selectedSchedule !=
                                                      null
                                                  ? 'assets/images/edit_schedule_enable.png'
                                                  : 'assets/images/edit_schedule_disable.png',
                                              enable: manageCubit
                                                      .selectedSchedule !=
                                                  null,
                                            ),
                                            ScheduleDialogButton(
                                              ...
                                              icon:
                                                  'assets/images/cyclic_schedule.png',
                                              enable: true,
                                            ),
                                            ScheduleDialogButton(
                                              title: AppText
                                                  .txtAddSingleSchedule.text
                                                  .toUpperCase(),
                                              onTap: () {
                                                Navigator.of(context).pop();
                                                showDialog(
                                              ...
                                              icon:
                                                  'assets/images/single_schedule.png',
                                              enable: true,
                                            ),
                                          ],
                                        ),
