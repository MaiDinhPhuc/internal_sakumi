...
class IconStatusInStudentProfile extends StatelessWidget {
  IconStatusInStudentProfile({super.key, required this.stdClass, required this.std, required this.cubit});
  final StudentClassModel stdClass;
  final StudentModel std;
  final StudentInfoCubit cubit;
  final List<String> listStudentStatusMenu = [
    "Completed",
    "InProgress",
    "Viewer",
    "ReNew",
      ...
      child: BlocBuilder<MenuPopupCubit, int>(
        builder: (c, s) {
          ...
          return PopupMenuButton(
            itemBuilder: (context) => [
              ...listStudentStatusMenu.map((e) => PopupMenuItem(
