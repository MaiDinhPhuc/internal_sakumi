...
import 'package:internal_sakumi/features/admin/voucher/app_voucher/voucher_app_form.dart';
import 'package:internal_sakumi/features/admin/voucher/app_voucher/voucher_app_image.dart';
import 'package:internal_sakumi/features/admin/voucher/voucher_cubit.dart';
import 'package:internal_sakumi/utils/resizable.dart';

class VoucherAppView extends StatelessWidget {
  final VoucherCubit cubit;
  const VoucherAppView(this.cubit, {Key? key}) : super(key: key);
          ...
          IntrinsicHeight(
            child: Row(
              children: [
                ...
                Expanded(flex: 8, child: VoucherAppForm(cubit)),
                Expanded(flex: 1, child: Container()),
                Container(
                ...
                Expanded(flex: 1, child: Container()),
                Expanded(flex: 20, child: VoucherAppImage(cubit)),
                Expanded(flex: 1, child: Container()),
              ],
            ),
          ),
