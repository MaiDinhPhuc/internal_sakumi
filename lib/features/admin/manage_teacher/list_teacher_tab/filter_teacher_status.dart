...
import 'list_teacher_cubit.dart';

class FilterTeacherStatus extends StatelessWidget {
  const FilterTeacherStatus( {super.key, required this.cubit});
                  ...
                  ...cubit.listStatus.map((e) => PopupMenuItem(
                      ...
                      child: BlocProvider(
                          create: (c) => CheckBoxFilterCubit(
                              cubit.status[cubit.listStatus.indexOf(e)]),
