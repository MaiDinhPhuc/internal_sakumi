            ...
            child: ListView.builder(
                ...
                itemBuilder: (c, index) {
                  ...
                  if (data["name"].toString().toLowerCase().contains(
                      ...
                      data["teacher_code"].toString().toLowerCase().contains(
                          scheduleCubit.teacherSearchValue.toLowerCase()) ||
                      data["email"].toString().toLowerCase().contains(
                          scheduleCubit.teacherSearchValue.toLowerCase())) {
                    return ItemSearchV2(
...
class ClassSearchCyclicSchedule extends StatelessWidget {
  const ClassSearchCyclicSchedule(
...
class TeacherSearchCyclicSchedule extends StatelessWidget {
  const TeacherSearchCyclicSchedule(
      {super.key, required this.addCubit, required this.snapshots});
  final AddCyclicScheduleCubit addCubit;
  final AsyncSnapshot<QuerySnapshot<Object?>> snapshots;
  @override
...
class ClassSearchSingleSchedule extends StatelessWidget {
  const ClassSearchSingleSchedule(
      {super.key, required this.addCubit, required this.snapshots});
