...
class ManageBrowseDownloadInClassDialog extends StatelessWidget {
  const ManageBrowseDownloadInClassDialog({super.key, required this.cubit});

  final ManageBrowseDownloadInClassCubit cubit;

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ManageBrowseDownloadInClassCubit, int>(
        bloc: cubit..loadData(),
        builder: (c, s) {
          return cubit.listBrowseDownload == null
              ? const WaitingAlert()
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(
                        flex: 7,
                        child: BrowseDownloadInClassView(cubit: cubit)),
                    Expanded(
                        flex: 1,
                        child: Container(
                            margin: EdgeInsets.only(
