...
class FilterCourseLevel extends StatelessWidget {
  const FilterCourseLevel(this.cubit, {super.key});
        ...
        child: ClipRRect(
          ...
          child: Material(
            ...
            child: PopupMenuButton(
                ...
                itemBuilder: (context) => [
                      ...cubit.listLevel.map((e) => PopupMenuItem(
                          padding: EdgeInsets.zero,
                          child: BlocProvider(
                              create: (c) => CheckBoxFilterCubit(
                                  cubit.listLevelState[cubit.listLevel.indexOf(e)]),
                              child: BlocBuilder<CheckBoxFilterCubit, bool>(
                                ...
                                return CheckboxListTile(
                                  ...
                                  value: state,
                                  onChanged: (newValue) {
                                    cubit.listLevelState[cubit.listLevel
                                        .indexOf(e)] = newValue!;
                                    if (cubit.listLevelState
