...
class FilterCourseType extends StatelessWidget {
  const FilterCourseType(this.cubit,{super.key});
                  ...
                  ...cubit.listType.map((e) => PopupMenuItem(
                      ...
                      child: BlocProvider(
                          create: (c) => CheckBoxFilterCubit(
                              cubit.listTypeState[cubit.listType.indexOf(e)]),
                          child: BlocBuilder<CheckBoxFilterCubit, bool>(
                              builder: (cc, state) {
                                return CheckboxListTile(
                                  ...
                                  value: state,
                                  onChanged: (newValue) {
                                    cubit.listTypeState[cubit.listType
                                        .indexOf(e)] = newValue!;
                                    if (cubit.listTypeState
