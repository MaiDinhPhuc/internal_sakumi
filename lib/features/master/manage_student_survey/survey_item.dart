...
class StudentSurveyItem extends StatelessWidget {
  const StudentSurveyItem({super.key, required this.surveyModel, required this.cubit});
...
class TeacherSurveyItem extends StatelessWidget {
  const TeacherSurveyItem({super.key, required this.surveyModel, required this.cubit});
  final SurveyModel surveyModel;
