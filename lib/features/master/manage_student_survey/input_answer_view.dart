...
import 'package:internal_sakumi/features/master/manage_student_survey/edit_student_survey_cubit.dart';
import 'package:internal_sakumi/utils/resizable.dart';

import '../manage_teacher_survey/edit_teacher_survey_cubit.dart';
...
class InputTeacherAnswerView extends StatelessWidget {
  const InputTeacherAnswerView(
      {super.key,
        required this.editSurveyCubit,
        required this.type,
        required this.isExpand,
