...
class EditStudentSurveyQuestionView extends StatelessWidget {
  EditStudentSurveyQuestionView({super.key, required this.detailSurveyCubit})
      : editSurveyCubit = EditStudentSurveyCubit(detailSurveyCubit);
  ...
  Widget build(BuildContext context) {
    return detailSurveyCubit.selector == -1
        ? Container()
        : BlocBuilder<EditStudentSurveyCubit, int>(
