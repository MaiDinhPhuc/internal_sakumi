...
class DetailStudentSurveyCubit extends Cubit<int> {
  DetailStudentSurveyCubit() : super(0);
  ...
  loadSurvey(int id, ManageStudentSurveyCubit surveyCubit) {
