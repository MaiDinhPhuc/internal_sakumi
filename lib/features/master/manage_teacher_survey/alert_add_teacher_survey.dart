...
void alertAddNewTeacherSurvey(BuildContext context, ManageTeacherSurveyCubit cubit) {
                                    ...
                                    if (formKey.currentState!.validate()) {
                                      ...
                                      if (context.mounted) {
                                        ...
                                        Navigator.pushNamed(context,
                                            '${Routes.master}/manageTeacherSurvey/id=$millisecondsSinceEpoch');
                                      }
                                    } else {
