                    ...
                    children: [
                      Expanded(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              isEdit
                                  ? AppText.txtEditCourseInfo.text.toUpperCase()
                              ...
                              children: [
                                if (isEdit)
                                  Container(
                                    ...
                                    child: DeleteButton(
                                        onPressed: ()async {
                                          await FireBaseProvider.instance.updateCourseState(courseModel!);
                                          cubit.loadAfterDelete(courseModel);
                                          Navigator.pop(context);
                                        },
                                        title: AppText.btnDisableCourse.text),
                                  ),
                                Row(
                                          ...
                                          onPressed: () async {
                                            if (formKey.currentState!
                                              ...
                                              if (!isEdit) {
                                                ...
                                                await FireBaseProvider.instance.updateCourseInfo(
                                                    CourseModel(
                                                        courseId: int
                                                            .parse(idCon
                                                            .text),
                                                ...
                                                if (context.mounted) {
                                                  ...
                                                  cubit.loadAfterEdit(
                                                      CourseModel(
                                                          ...
                                                          token: tokenCon.text,
                                                          code: codeCon.text,
                                                          enable: true), courseModel!.courseId
                                                  );
                                                }
                                              }
                                            } else {
